    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "סטודיו טוליפ Studio Tulip משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '66940e35-7410-43e8-8cbb-c40cc6bb0b19',
                    name: data.name || '',
                    email: data.email || '',
